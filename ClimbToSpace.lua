...
createButton("Inf Coins", function()
    local args = {"Coin", math.huge}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Data"):WaitForChild("RemoteEvents"):WaitForChild("AddSingleStat"):FireServer(unpack(args))
end)

createButton("Inf Trophies", function()
    local args = {"Trophy", math.huge}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Data"):WaitForChild("RemoteEvents"):WaitForChild("AddSingleStat"):FireServer(unpack(args))
end)

createButton("Get Unicorn Pet", function()
    local args = {"Pets", "Unicorn"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Data"):WaitForChild("RemoteEvents"):WaitForChild("UpdateInventory"):FireServer(unpack(args))
end)
